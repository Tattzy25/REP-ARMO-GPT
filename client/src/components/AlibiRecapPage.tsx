      ...
      >
        ...
        <div className="flex justify-center">
          <motion.button
            ...
            transition={{ duration: 0.5, delay: 0.8 }}
            onClick={onNext}
            className="relative flex items-center gap-2 px-8 py-4 rounded-full border-none cursor-pointer transform transition-all duration-300 hover:scale-110 active:scale-100"
            style={{
              backgroundColor: 'transparent',
              transformOrigin: 'center'
            }}
            onMouseEnter={(e) => {
              e.currentTarget.style.setProperty('--active', '1');
            }}
            onMouseLeave={(e) => {
          ...
          >
            {/* Background layer */}
            <div 
              className="absolute top-1/2 left-1/2 w-full h-full rounded-full transition-all duration-300 z-0"
              style={{
                transform: 'translate(-50%, -50%)',
                backgroundColor: 'hsl(0, 0%, 12%)',
                boxShadow: 'inset 0 0.5px hsl(0, 0%, 100%), inset 0 -1px 2px 0 hsl(0, 0%, 0%), 0px 4px 10px -4px hsla(0, 0%, 0%, 0.8), 0 0 0 calc(var(--active, 0) * 0.375rem) hsl(260, 97%, 50%, 0.75)'
              }}
            />
            
            {/* Gradient overlay */}
            <div 
              className="absolute top-1/2 left-1/2 w-full h-full rounded-full transition-opacity duration-300 z-10"
              style={{
                transform: 'translate(-50%, -50%)',
            ...
            >
              <div 
                className="absolute top-1/3 left-1/2 w-full h-8 bg-white animate-spin"
                style={{
                  transform: 'translate(-50%, -50%)',
            ...
            {/* Button text */}
            <span 
              className="relative z-20 text-base font-medium"
              style={{
